...
SIMS_2D = [
    ...
    {"path": "S3_384_azi", "label": "384 azi", "n_azi": 384},
    {"path": "S4_512_azi", "label": "512 azi", "n_azi": 512},
    {"path": "S5_640_azi", "label": "640 azi", "n_azi": 640},
    {"path": "S6_1024_azi", "label": "1024 azi", "n_azi": 1024},
]
...
for sim in SIMS_2D:
    ...
    if not os.path.exists(sim_path):
        raise FileNotFoundError(f"Simulation path not found: {sim_path} for {sim['label']}")
